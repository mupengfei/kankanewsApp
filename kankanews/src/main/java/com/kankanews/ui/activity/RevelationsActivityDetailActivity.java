...
import com.kankanews.ui.popup.RevelationsChoiceBottomBoard;
...
public class RevelationsActivityDetailActivity extends BaseContentActivity implements
		OnClickListener {
	private String aid;
	...
	protected void refreshNetDate() {
		...
		if (CommonUtils.isNetworkAvailable(this)) {
			this.mNetUtils.getRevelationsActivityList(this.aid, "",
					this.mSuccessListener, mErrorListener);
		} else {
	...
	protected void initView() {
		// TODO Auto-generated method stub
		initTitleLeftBar("活动详情", R.drawable.ic_left_back);
	...
	private class ActivityListAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			if (itemViewType == 0) {
				...
				topHolder.activityIntro = (TfTextView) convertView
			...
			if (itemViewType == 0) {
				RevelationsActivities activity = revelationsActivityList
						.getActivity();
