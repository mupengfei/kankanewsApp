...
//		ImageLoader.getInstance(3, ImageOptions.Type.LIFO).loadImage(url,
//				(ImageView) getView(viewId));
        ImgUtils.imageLoader.displayImage(url, (ImageView) getView(viewId), ImgUtils.homeImageOptions);
        return this;
    }
